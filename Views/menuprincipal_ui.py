...
"")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("investigacion.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"QPushButton:hover{background-color:white; border-top-right-radius: 20px;border-bottom-right-radius: 20px;color: rgb(0,0,0);}")
        ...
        self.btn_listaClientes.setGeometry(QtCore.QRect(130, 340, 290, 50))
...
"QPushButton:hover{background-color:white; border-top-right-radius: 20px;border-bottom-right-radius: 20px;color: rgb(0,0,0);}")
        ...
        self.label_10.setPixmap(QtGui.QPixmap("investigacion.png"))
