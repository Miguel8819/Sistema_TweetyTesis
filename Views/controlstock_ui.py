...
#Inputs con validadores
    ...
    def retranslateUi(self, controlstock):
        ...
        item.setText(_translate("controlstock", "Cód. Producto"))
        item = self.table_product.horizontalHeaderItem(1)
        item.setText(_translate("controlstock", "Cód. de Barras"))
        ...
        item.setText(_translate("controlstock", "Unidad Medida"))
        ...
        item.setText(_translate("controlstock", "Stock Min."))
        ...
        item.setText(_translate("controlstock", "Costo Compra"))
