...
class Ui_informeDeVentas(object):
    ...
    def setupUi(self, informeDeVentas):
        ...
        self.Btn_Volver.setGeometry(QtCore.QRect(420, 490, 75, 23))
        font = QtGui.QFont()
...
"")
        ...
        self.Btn_limpiar1 = QtWidgets.QPushButton(self.tab)
        self.Btn_limpiar1.setGeometry(QtCore.QRect(500, 90, 75, 23))
        self.Btn_limpiar1.setStyleSheet("background-color: rgb(218, 218, 218);")
        self.Btn_limpiar1.setObjectName("Btn_limpiar1")
        ...
        self.Btn_volver2.setGeometry(QtCore.QRect(410, 470, 75, 23))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.Btn_volver2.setFont(font)
        ...
        self.Btn_limpiar2 = QtWidgets.QPushButton(self.tab_2)
        self.Btn_limpiar2.setGeometry(QtCore.QRect(570, 100, 75, 23))
        self.Btn_limpiar2.setStyleSheet("background-color: rgb(218, 218, 218);")
        self.Btn_limpiar2.setObjectName("Btn_limpiar2")
...
"")
        ...
        self.Btn_limpiar3 = QtWidgets.QPushButton(self.tab_3)
        self.Btn_limpiar3.setGeometry(QtCore.QRect(220, 170, 75, 23))
        self.Btn_limpiar3.setStyleSheet("background-color: rgb(218, 218, 218);")
        self.Btn_limpiar3.setObjectName("Btn_limpiar3")
        self.tabWidget.addTab(self.tab_3, "")
        self.tab_4 = QtWidgets.QWidget()
        self.tab_4.setObjectName("tab_4")
        self.label_7 = QtWidgets.QLabel(self.tab_4)
        self.label_7.setGeometry(QtCore.QRect(290, 10, 251, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
...
"background-color: rgb(255, 0, 0);")
        ...
        self.Btn_limpiar4.setGeometry(QtCore.QRect(380, 100, 75, 23))
        self.Btn_limpiar4.setStyleSheet("background-color: rgb(218, 218, 218);")
        self.Btn_limpiar4.setObjectName("Btn_limpiar4")
        self.tabWidget.addTab(self.tab_4, "")
        self.tab_5 = QtWidgets.QWidget()
        self.tab_5.setObjectName("tab_5")
        self.Btn_volver_5 = QtWidgets.QPushButton(self.tab_5)
        self.Btn_volver_5.setGeometry(QtCore.QRect(430, 530, 75, 23))
...
"font: 12pt \"MS Shell Dlg 2\";")
        ...
        self.label_15.setGeometry(QtCore.QRect(330, 10, 251, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.tableWidget_5.setGeometry(QtCore.QRect(150, 150, 631, 171))
        ...
        self.Btn_listar_3.setGeometry(QtCore.QRect(70, 150, 75, 23))
...
"")
        ...
        self.search_comprobante.setGeometry(QtCore.QRect(310, 80, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_14.setGeometry(QtCore.QRect(150, 80, 151, 21))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_14.setFont(font)
        self.label_14.setObjectName("label_14")
        self.motivo_anulacion = QtWidgets.QTextEdit(self.tab_5)
        self.motivo_anulacion.setGeometry(QtCore.QRect(590, 370, 191, 141))
        ...
        self.btn_verMotivo.setGeometry(QtCore.QRect(60, 370, 81, 23))
        ...
        self.tableWidget_6.setGeometry(QtCore.QRect(150, 370, 421, 141))
        ...
        self.label_13.setGeometry(QtCore.QRect(310, 340, 91, 31))
        self.label_13.setStyleSheet("font: 18pt \"MS Shell Dlg 2\";")
        self.label_13.setObjectName("label_13")
        self.Btn_limpiar5 = QtWidgets.QPushButton(self.tab_5)
        self.Btn_limpiar5.setGeometry(QtCore.QRect(450, 80, 75, 23))
        self.Btn_limpiar5.setStyleSheet("background-color: rgb(218, 218, 218);")
        self.Btn_limpiar5.setObjectName("Btn_limpiar5")
    ...
    def retranslateUi(self, informeDeVentas):
        ...
        self.Btn_Volver.setText(_translate("informeDeVentas", "Salir"))
        ...
        self.Btn_limpiar1.setText(_translate("informeDeVentas", "Limpiar todo"))
        ...
        item.setText(_translate("informeDeVentas", "Importe"))
        self.Btn_volver2.setText(_translate("informeDeVentas", "Salir"))
        ...
        self.Btn_limpiar2.setText(_translate("informeDeVentas", "Limpiar todo"))
        ...
        self.Btn_volver3.setText(_translate("informeDeVentas", "Salir"))
        ...
        self.Btn_limpiar3.setText(_translate("informeDeVentas", "Limpiar todo"))
        ...
        self.Btn_limpiar4.setText(_translate("informeDeVentas", "Limpiar todo"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("informeDeVentas", "Reporte de ventas "))
        self.Btn_volver_5.setText(_translate("informeDeVentas", "Salir"))
        ...
        item.setText(_translate("informeDeVentas", "Anuló"))
        ...
        self.btn_verMotivo.setText(_translate("informeDeVentas", "Mostrar Detalle"))
        item = self.tableWidget_6.horizontalHeaderItem(0)
        item.setText(_translate("informeDeVentas", "Producto"))
        item = self.tableWidget_6.horizontalHeaderItem(1)
        item.setText(_translate("informeDeVentas", "cantidad"))
        item = self.tableWidget_6.horizontalHeaderItem(2)
        item.setText(_translate("informeDeVentas", "Precio Unit"))
        item = self.tableWidget_6.horizontalHeaderItem(3)
        item.setText(_translate("informeDeVentas", "Subtotal"))
        self.label_13.setText(_translate("informeDeVentas", "Detalle"))
        self.Btn_limpiar5.setText(_translate("informeDeVentas", "Limpiar todo"))
