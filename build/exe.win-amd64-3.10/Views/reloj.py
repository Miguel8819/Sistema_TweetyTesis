...
# ventana.geometry('200x100+10+10')
# ventana.minsize(width=100, height=100)
...
# texto_dia = Label(ventana,  fg = 'white',  bg='gray2', font = ('Lucida Calligraphy',10))
# texto_dia.grid(row=1,sticky="nsew")
# texto_fecha = Label(ventana,  fg = 'green2',  bg='gray3', font = ('Comic Sans MS',10, 'bold'))
