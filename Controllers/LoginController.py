...
class LoginController():
    ...
    def modificarPassword(self, user, oldPassword, newPass, newPassRepeat):
        ...
        exit = False
        while exit == False:
            if returnValue == QMessageBox.Ok and user != "" and oldPassword !="" and newPass != "" and newPassRepeat != "" and newPass == newPassRepeat: 
                flag = 1
                exit = True
                ...
                flag = 3
                exit = True
            elif returnValue == QMessageBox.Ok and user and oldPassword:
                flag = 4
                exit = True
        ...
        if flag == 1:
            ...
            if status == True:
                ...
                msg = QMessageBox()
                msg.setWindowTitle("Error")
                msg.setText("Su usuario o contraseña en uso son incorrectas")
